...
/*   Updated: 2024/01/13 05:17:28 by maouzal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	fill_texter(t_mlx *mlx, char *str)
{
	...
	if (ft_strnstr(str, "NO ", 3))
		mlx->north_texture = ft_substr(str, get_start(mlx, str, 1), get_end(mlx, str, get_start(mlx, str, 1)) - 3);
	else if (ft_strnstr(str, "SO ", 3))
		mlx->south_texture = ft_substr(str, get_start(mlx, str, 1), get_end(mlx, str, get_start(mlx, str, 1)) - 3);
	else if (ft_strnstr(str, "WE ", 3))
		mlx->west_texture = ft_substr(str, get_start(mlx, str, 1), get_end(mlx, str, get_start(mlx, str, 1)) - 3);
	else if (ft_strnstr(str, "EA ", 3))
		mlx->east_texture = ft_substr(str, get_start(mlx, str, 1), get_end(mlx, str, get_start(mlx, str, 1)) - 3);
